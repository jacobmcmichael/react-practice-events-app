	...
	return (
		<main className="flex flex-col items-center px-3 pt-36">
			...
			<p className="mb-12 mt-7 text-2xl lg:text-3xl opacity-75">
				Browse more than <span className="font-bold text-[#a4f839] italic underline">10,000</span> events around
				you
			</p>
			...
			>
				<input
					className="w-full h-16 rounded-lg bg-white/[7%] focus:bg-white/10 px-6 outline-none ring-[#a4f839]/50 focus:ring-2 transition"
					type="text"
